...
//	}
	...
	public Tree<Esecdptdef> getTree() {
        ...
        List<Esecdptdef> depts = deptDao.list(new HashMap<String, Object>(16));
        ...
        List<Esecusrdef> users = userDao.userList(new HashMap<String, Object>(16));
